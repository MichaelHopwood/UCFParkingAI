...
class DataHandler():
    ...
    def report(self):
        try:
            ...
            elif self.power_units == 'Capacity (%)':
    ...
    def plot_heatmap(self, matrix='raw', flag=None, figsize=(12, 6),
        ...
        if flag is None:
            ...
            fig = plot_2d(mat, figsize=figsize,
                          ...
                          dates=self.day_index, year_lines=year_lines,
                          units=units)
            plt.title('Measured capacity, good days flagged')
            return fig
        elif flag == 'bad':
            fig = plot_2d(mat, figsize=figsize,
                          clear_days=~self.daily_flags.no_errors,
                          dates=self.day_index, year_lines=year_lines,
                          units=units)
            plt.title('measured capacity, bad days flagged')
            return fig
            ...
            fig = plot_2d(mat, figsize=figsize,
                          ...
                          dates=self.day_index, year_lines=year_lines,
                          units=units)
            plt.title('measured capacity, clear days flagged')
            return fig
        elif flag == 'cloudy':
            fig = plot_2d(mat, figsize=figsize,
                          ...
                          dates=self.day_index, year_lines=year_lines,
                          units=units)
            plt.title('measured capacity, cloudy days flagged')
            return fig
        elif flag == 'clipping':
            fig = plot_2d(mat, figsize=figsize,
                          ...
                          dates=self.day_index, year_lines=year_lines,
                          units=units)
            plt.title('measured capacity, days with inverter clipping flagged')
            return fig
        else:
